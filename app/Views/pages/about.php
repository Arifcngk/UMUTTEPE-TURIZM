            ...
            <div class="row">
                ...
                <div class="col-lg-8 d-flex flex-column align-items-stretch">
                            ...
                            <div class="col-lg-6">
                                <ul>
                                    ...
                                    <li><i class="bi bi-chevron-right"></i> <strong>Tel:</strong>
                                        <span>0 (262) 532 23 11</span>
                                    </li>
                                    <li><i class="bi bi-chevron-right"></i> <strong>Email:</strong>
                                        <span>info@umuttepeturizm.com</span>
                                    </li>
                                    <li><i class="bi bi-chevron-right"></i> <strong>Çalışma Saatleri:</strong>
                                        <span>7/24</span>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div class="row mt-n4">
                            <div class="col-md-6 mt-5 d-md-flex align-items-md-stretch">
                                <div class="count-box">
                                    ...
                                    <p><strong>Mutlu Müşteri </strong> consequuntur voluptas nostrum aliquid ipsam
                                        architecto ut.</p>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 mt-5 d-md-flex align-items-md-stretch">
                                <div class="count-box">
                                    ...
                                    <span data-purecounter-start="0" data-purecounter-end="521"
                                        data-purecounter-duration="1" class="purecounter"></span>
                                    <p><strong>Sefer</strong> adipisci atque cum quia aspernatur totam laudantium
                                        et quia dere tan</p>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 mt-5 d-md-flex align-items-md-stretch">
                                <div class="count-box">
                                    ...
                                    <span data-purecounter-start="0" data-purecounter-end="18"
                                        data-purecounter-duration="1" class="purecounter"></span>
                                    <p><strong>Hızlı Satın Alma</strong> aut commodi quaerat modi aliquam nam
                            ...
                            <div class="col-md-6 mt-5 d-md-flex align-items-md-stretch">
                                <div class="count-box">
                                    ...
                                    <span data-purecounter-start="0" data-purecounter-end="16"
                                        data-purecounter-duration="1" class="purecounter"></span>
                                    <p><strong>Ödül</strong> rerum asperiores dolor alias quo reprehenderit eum et
                                        nemo pad der</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="skills-content ps-lg-4">
                        <div class="progress">
                            <span class="skill">Öğrenci <i class="val">758</i></span>
                        ...
                        <div class="progress">
                            <span class="skill">Eğitimci <i class="val">289</i></span>
                            <div class="progress-bar-wrap">
                        ...
                        <div class="progress">
                            <span class="skill">Diğer <i class="val">958</i></span>
                            <div class="progress-bar-wrap">
    ...
    <section id="resume" class="resume">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <div class="resume-item pb-0">
                        ...
                        <ul>
                            ...
                            <li>İlk Sefer Kocaeli içinde ücretsiz yapıldı</li>
                            <li>Yoğun Talep Gözlendi</li>
                        </ul>
                        </p>
                    </div>

                    <h3 class="resume-title">İlk Sefer</h3>
                    <div class="resume-item">
                        <h4>Şehirler Arası İlk Sefer </h4>
                        <h5>2015 - 2016</h5>
                ...
                <div class="col-lg-6">
                    <h3 class="resume-title">Yılın Turizm Firması</h3>
                    <div class="resume-item">
                    ...
                    <div class="resume-item">
                        <h4>Öğrenci Dostu Ulaşım Hedefi</h4>
                        <h5>2017 - 2024</h5>
